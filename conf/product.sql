...
delimiter ;
CALL create_tables('product_',0,24);
CALL create_tables('product_daydelta_',0,5);
CALL create_tables('product_mindelta_',0,5);
CALL drop_table('product_new');
CALL create_table('product_new');
