...
delimiter ;
CALL create_tables('unproduct_',0,24);
CALL create_tables('unproduct_daydelta_',0,5);
CALL create_tables('unproduct_mindelta_',0,5);
CALL drop_table('unproduct_new');
CALL create_table('unproduct_new');
