...
//            $host = $resultset[0]['slaveHost'];
        ...
        $dbname = $dbname == 'product_a1' ? 'v2_product_a1' : $dbname;
        $dbname = $dbname == 'product_a2' ? 'v2_product_a2' : $dbname;
        $dbname = $dbname == 'product_b1' ? 'v2_product_b1' : $dbname;
        $dbname = $dbname == 'product_b2' ? 'v2_product_b2' : $dbname;
