...
class indexupdate_es_item
{
    ...
    public function updateTime($value)
    {
        if ($value == '0000-00-00 00:00:00') {
            ...
            $this->record['updateTime'] = strtotime($value);
        }
    ...
    public function deal($msg)
    {
        ...
        $this->record = $msg;
        $msgFields = array(
            'itemId',             // item_* saledItem_*
            'bizType',            // item_* saledItem_*
            'userId',             // item_* saledItem_*
            'catId',              // item_* saledItem_*
            'itemName',           // item_* saledItem_*
            'author',             // item_* saledItem_*
            'press',              // item_* saledItem_*
            'price',              // item_* saledItem_*
            'pubDate',            // item_* saledItem_*
            'years',              // item_* saledItem_*
            'discount',           // item_* saledItem_*
            'number',             // item_* saledItem_*
            'quality',            // item_* saledItem_*
            'addTime',            // item_* saledItem_*
            'reCertifyStatus',    // item_* saledItem_*
            'imgUrl',             // item_* saledItem_*
            'tag',                // item_* saledItem_* 中文非数字ID
            'certifyStatus',      // item_* saledItem_*
            'olReceiveType',      // item_* saledItem_*
            'isDelete',           // item_* saledItem_*
            'updateTime',         // item_*
            'approach',           // item_*
            'itemDesc',           // itemDesc_* saledItemDesc_*
            'isbn',               // itemDesc_* saledItemDesc_*
            'params',             // itemDesc_* saledItemDesc_*
            'saleStatus',         // 0未售   /   1已售
            'nickname',           // shopInfo
            'shopName',           // shopInfo
            'shopId',             // shopInfo
        ...
        //itemId
        $msg['itemId'] = $this->itemId($msg['itemId']);
        
        //hasImg
        $msg['hasImg'] = $this->hasImg(1);
        
        //price
        $msg['price'] = $this->price($msg['price']);
        
        //number
        $msg['number'] = $this->number($msg['number']);
        ...
        //area
        $msg['area'] = $this->area($msg['publicArea']);
        unset($msg['publicArea']);
        ...
        //itemDesc
        $msg['itemDesc'] = $msg['itemDesc'];
        
        //qualityDesc
        if(isset($msg['qualityDesc'])) {
            $msg['qualityDesc'] = $msg['qualityDesc'];
        }
        
        //shopStatus
        $msg['shopStatus'] = $this->shopStatus($msg['shopStatus']);
        
        //certifyStatus
        $msg['certifystatus'] = $this->certifyStatus($msg['certifyStatus']);
        unset($msg['certifyStatus']);
        
        //olReceiveType
        $msg['olreceivetype'] = $this->olReceiveType($msg['olReceiveType']);
        unset($msg['olReceiveType']);
        ...
        //updateTime
        $msg['updateTime'] = $this->updateTime($msg['updateTime']);
        
        //approach
        $msg['approach'] = $this->approach($msg['approach']);
        ...
        //tag
        $msg['tag'] = $this->fan2jian($msg['tag']);
        
        //_tag
        $msg['_tag'] = $msg['tag'];
        
        //itemDesc
        $msg['itemDesc'] = $this->fan2jian($msg['itemDesc']);
        
        //_nickname
        $msg['_nickname'] = $this->fan2jian($msg['nickname']);
        
        //_shopName
        $msg['_shopName'] = $this->fan2jian($msg['shopName']);
    ...
    public function dealUp($msg)
    {
        ...
        //itemId
        if(isset($msg['bizType']) && isset($msg['itemId'])) {
            $msg['itemId'] = $this->itemId($msg['itemId']);
        }
        ...
        //hasImg
        if(isset($msg['hasImg']) || isset($msg['imgUrl'])) {
            $msg['hasImg'] = $this->hasImg(1);
        }
        
        //price
        if(isset($msg['price']) && $msg['price']) {
            $msg['price'] = $this->price($msg['price']);
        }
        
        //number
        if(isset($msg['number']) && $msg['number']) {
            $msg['number'] = $this->number($msg['number']);
        }
        ...
        //shopStatus
        if(isset($msg['shopStatus']) && $msg['shopStatus']) {
            $msg['shopStatus'] = $this->shopStatus($msg['shopStatus']);
        }
        
        //certifyStatus
        if(isset($msg['certifyStatus']) && $msg['certifyStatus']) {
            $msg['certifystatus'] = $this->certifyStatus($msg['certifyStatus']);
            unset($msg['certifyStatus']);
        }
        
        //olReceiveType
        if(isset($msg['olReceiveType'])) {
            $msg['olreceivetype'] = $this->olReceiveType($msg['olReceiveType']);
            unset($msg['olReceiveType']);
        }
        
        //rank
        if(isset($msg['imgUrl']) && isset($msg['class']) && isset($msg['addTime'])) {
            $msg['rank'] = $this->rank(0);
        }
        ...
        //rank10
        if(isset($msg['rank10'])) {
            $msg['rank10'] = $msg['rank10'];
        }
        
        //rank100
        if(isset($msg['rank100'])) {
            $msg['rank100'] = $msg['rank100'];
        }
...
//        $msg['trust'] = $this->trust(0);
        ...
        //updateTime
        if(isset($msg['updateTime']) && $msg['updateTime']) {
            $msg['updateTime'] = $this->updateTime($msg['updateTime']);
        }
        
        //approach
        if(isset($msg['approach'])) {
            $msg['approach'] = $this->approach($msg['approach']);
        }
