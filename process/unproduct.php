...
class unproduct extends Convertor
{
    private $tagPDO;
    private $mapPDO;
    private $cache;
    ...
    {
        if($this->dataType == 'saleoutandisdeletesaleditem' || $this->dataType == 'shopclosesaleditem') {
    ...
    public function itemDesc($value)
    {
        ...
        $sql = "SELECT params, itemDesc FROM $table WHERE itemId = $itemID";
