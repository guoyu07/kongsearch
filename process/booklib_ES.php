...
class booklib_es extends Convertor
{
    private $cache;
    private $expire;
    private $booklibPDO;
    ...
    {
        return isset($this->record['booksDesc']['editorComment']) ? mb_substr($this->record['booksDesc']['editorComment'], 0, 10000, 'UTF-8') : '';
    }

    public function contentIntroduction($value)
    {
        return isset($this->record['booksDesc']['contentIntroduction']) ? mb_substr($this->record['booksDesc']['contentIntroduction'], 0, 10000, 'UTF-8') : '';
    }

    public function directory($value)
    {
        return isset($this->record['booksDesc']['directory']) ? mb_substr($this->record['booksDesc']['directory'], 0, 10000, 'UTF-8') : '';
    }

    public function Illustration($value)
    {
        return isset($this->record['booksDesc']['Illustration']) ? mb_substr($this->record['booksDesc']['Illustration'], 0, 10000, 'UTF-8') : '';
    }

    public function description($value)
    {
        return isset($this->record['booksDesc']['description']) ? mb_substr($this->record['booksDesc']['description'], 0, 10000, 'UTF-8') : '';
    }
