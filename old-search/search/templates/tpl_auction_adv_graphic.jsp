  ...
  <div class="right">
    ...
    <div id="rightBox1">
      ...
      <table width="94%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
            <td align="right">拍品编号：</td>
            <td><input type="text" id="itemId" name="itemId" value="<%=encodeForHTML(itemId)%>" maxlength="11" style="width:136px;" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" id="press" name="press" value="<%=encodeForHTML(press)%>" style="width:136px" /></td>
          </tr>
        <tr title="按年月日查询，格式：20090501">
          <td height="30" align="right">出版日期：</td>
        ...
        <tr>
          ...
          <td><input class="Wdate" id="beginTimeS" name="beginTimeS" onfocus="new WdatePicker(this,'%Y-%M-%D',true)" 
onpicked="$search('beginTimeE').onfocus()" maxdate="#F{$search('beginTimeE').value}" size="11"  value="<%=encodeForHTML(beginTimeS)%>" /> 至</td>
          </tr>
        <tr>
            <td align="right">&nbsp;</td>
          <td>
<input class="Wdate" id="beginTimeE" name="beginTimeE" onfocus="new WdatePicker(this,'%Y-%M-%D',true)" 
maxdate="2100-1-1" mindate="#F{$search('beginTimeS').value}" size="11" value="<%=encodeForHTML(beginTimeE)%>" /> <a href="javascript:void(0);" onclick="resetDate('beginTime');" style="color:gray" >清空</a></td>
          </tr>
        <tr>
          <td align="right">结束时间：</td>
          <td><input class="Wdate" id="endTimeS" name="endTimeS" onfocus="new WdatePicker(this,'%Y-%M-%D',true)" 
onpicked="$search('endTimeE').onfocus()" maxdate="#F{$search('beginTimeE').value}" size="11" value="<%=encodeForHTML(endTimeS)%>" /> 至</td>
          </tr>
        <tr>
            <td align="right">&nbsp;</td>
          <td><input class="Wdate" id="endTimeE" name="endTimeE" onfocus="new WdatePicker(this,'%Y-%M-%D',true)" 
maxdate="2100-1-1" mindate="#F{$search('endTimeS').value}" size="11" value="<%=encodeForHTML(endTimeE)%>" /> <a href="javascript:void(0);" onclick="resetDate('endTime');" style="color:gray" >清空</a></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
  ...
  <div class="left">
    <div id="list">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <th width="57%" colspan="2"><%=htmlViewStylePanel%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="color:black">排序：</strong>
      ...
      <th width="12%" valign="top" style="font-weight:normal" align="center" >起拍价/最高价</th>
      <th width="10%" valign="top" style="font-weight:normal" align="center" >竞标/阅读</th>
      <th width="10%" valign="top" align="center" style="font-weight:normal">结束时间</th>
        </tr>
