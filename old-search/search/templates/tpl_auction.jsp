...
.searchHint{position:absolute;top:255px;left:600px;
    ...
    <form id="frmSearchItems" name="frmSearchItems" method="get" action="auction.jsp" onkeypress="if(event.keyCode==13)this.submit();">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="16%" >
          	<select id="categorySel" style="width:146px;" onchange="changeCategory(this.value);">
          		<%=htmlCategoryOptions%>
          	</select>
          </td>
...
<DIV id="resultList">
  <div class="title01"><%=htmlViewStylePanel%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="color:black">排序：</strong>
    ...
    <script type="text/javascript">$search("sorttypeSelect").value="<%=sorttype %>";</script>
  </div>
<!--list begin-->
<%
