...
.toolbar li{float:left; margin-left:2px;}
...
<form id="frmSearchBook" name="frmSearchBook" method="get" action="book_adv.jsp" onkeypress="if(event.keyCode==13)this.submit();">
        ...
        <table width="94%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
        	...
        	<td><input type="text" style="width:136px;" name="query" id="query" value="<%=encodeForHTML(query)%>" /></td>  
          </tr>
          <tr>
...
<script>$search("priceLevel").value="<%=encodeForJavaScript(priceLevel)%>";</script>
          ...
          <tr>
            ...
            <td height="25"><select style="width:140px;" id="state" name="state" onchange="linkage.fillCounty(this.value, $search('county'))"></select></td>
          </tr>
          <tr>
              <td align="right">&nbsp;</td>
            <td height="25"><select style="width:140px;" id="county" name="county"><option value="">全部</option></select></td>
          </tr>
          <tr>
            <td align="right" title="请输入年月，格式如：201110">出版日期：</td>
            <td title="请输入年月，格式如：201110"><input type="text" id="pubDateStart" name="pubDateStart" size="6" maxlength="6" value="<%=encodeForHTML(pubDateStart)%>" />&nbsp;至&nbsp;<input type="text" id="pubDateEnd" name="pubDateEnd" size="6" maxlength="6" value="<%=encodeForHTML(pubDateEnd)%>" /></td>
          </tr>
          <tr>
          ...
          <tr title="出版日期在六年前的为旧书，六年内的为新书。">
            ...
            <td>
            <label><select style="width:140px;" id="isNewBook" name="isNewBook"><%=htmlIsNewBook%></select></label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
