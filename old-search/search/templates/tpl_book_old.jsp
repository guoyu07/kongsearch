  ...
  <table align="center" style="margin:auto">
    <tr>
      ...
      <td><span id="shopPanelConent" style="display:block;">
        <form id="frmSearchShop" name="frmSearchShop" method="get" action="book_old.jsp">
          ...
          <label><img onclick="searchSubmit()" style="cursor:pointer;" src="images/bt_precise_search_list.gif" alt="搜索" align="absmiddle" /> 
          <a href="book_adv.html" target="_blank">高级搜索</a> 
          <!--<a href="/" target="_blank">新版搜索首页</a> -->
...
<div id="sx">
  <!--search begin-->
  <div class="search">
    <form id="frmSearchBook" name="frmSearchBook" method="get" action="book_old.jsp" onkeypress="if(event.keyCode==13)this.submit();">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="right">新旧书：</td>
          <td align="left"><select style="width:140px;" id="isNewBook" name="isNewBook"><%=htmlIsNewBook%></select></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                  <td width="50%">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                       <td width="72" align="right" title="请输入年月，格式如：201110">出版日期：</td>
                       <td align="left">
                         <label>
                            <input type="text" id="pubDateStart" name="pubDateStart" style="width:57px;" maxlength="6" value="<%=encodeForHTML(pubDateStart)%>" />
                            &nbsp;至&nbsp;
                            <input type="text" id="pubDateEnd" name="pubDateEnd" style="width:57px;" maxlength="6" value="<%=encodeForHTML(pubDateEnd)%>" /> 
                            格式：201110&nbsp;
                         </label>
                        </td>
                     </tr>
                  ...
                  <td width="50%">
	               <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              	<tr>
	              	  <td width="50" align="right">省市：</td>
	              	  <td width="293">
	              	    <label title="出版日期在六年前的为旧书，六年内的为新书。">
	                     <label><select style="width:140px;" id="state" name="state" onchange="linkage.fillCounty(this.value, $search('county'))"></select></label>
	                     <label><select style="width:140px;" id="county" name="county" ><option value="">全部</option></select></label>
	                    </label>
	                  </td>
	                </tr>
	               </table>
...
%>
  ...
  <div class="page"><!--查询的图书总数：，共 <font class="red2"></font> 页--><br />
    <div><%=htmlPageNavigation%><div class="clear"></div></div>
  </div>
  <%=queryMoreHtml%>
  <!--分页结束-->
</DIV>
...
<%
    ...
    sb.append(" src=\"http://www.baidu.com/s?si=book.kongfz.com&cl=3&ct=2097152&word="+query+"&tn=baidulocal\" ");
