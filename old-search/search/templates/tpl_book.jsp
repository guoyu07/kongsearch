...
#searchInvestDiv{ width:22px; height:159px; display:block; line-height:13px; font-size:12px; position:absolute; top:0px; left:0px;}
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="15%" align="left">
              <input type="text" name="author" value="<%=encodeForHTML(author)%>" style="width:136px;"/>
            </td>
