...
<%
response.sendRedirect("http://search.kongfz.com/pm/");
...
if("graphic".equals(viewStyle)){
    tplName = "tpl_auction_graphic.jsp" ;
    viewListRows = "50";
}else{
    tplName = "tpl_auction.jsp";
    viewListRows = "100";
}
...
if(null != server){
	...
	System.out.println("历史拍卖服务器异常"+date_format.format(new Date())+"=================>");
        ex.printStackTrace();
	...
	System.out.println("搜索返回结果："+result);
...
String htmlPageNavigation = displayNavigation(StringUtils.intVal(pageTotal), StringUtils.intVal(currentPage), request.getQueryString(), "auction.jsp");
