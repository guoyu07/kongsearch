...
out.write(keywords);
    ...
    try{
        ...
        manager = (ServiceInterface) Naming.lookup("rmi://192.168.1.105:1888/BookVerifyService");
    }catch(Exception ex){
        manager = null;
        ex.printStackTrace();
    }
...
//                    public void run() {
                         ...
                         * params.5 : 审核操作对象[n = 人工审核]
                        synchronized (neoSearch){
                            neoSearch.work(finalAct,finalItemList,"itemId","bizType",null);
                        }
						 */
//                    }
//               }).start();
...
out.write("<br/>docBaseType : "+docBaseType);
