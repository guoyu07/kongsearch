...
/***********************************************************/
    ...
    private void sendNewSearchAutoSmartVerify(String act, ArrayList logList, JspWriter out) throws Exception {
        ...
        neoSearch.work(neoBookParams,logList);
    ...
    if(null != manager){
        ...
        if("Search".equalsIgnoreCase(act)){
            ...
            parameters.put("paginationSize", "100");//每页显示数据条数
                        ...
                        String[] verifyActsNotApprove = {"reject" , "delete" , "frozen","approve"};//审核操作【不包含通过】
            int[] totalCountPage = {40 , 2 , 1,6000};//总页数，与上面的对应【审核日志查询到的页码号 * 2】
		//修改这几个类型的数据
