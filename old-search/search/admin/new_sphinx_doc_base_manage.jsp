...
//            String isCreatePage = StringUtils.strVal(map.get("isCreatePage"));
            ...
            String category     = StringUtils.strVal(indexBook.getCatid());//顶级分类 * ~
...
*/
        ...
        // 查询索引服务
        if (StringUtils.inArray(act, "Search", "OnlineSale", "DownRepeal", "RecycleBin", "ShutShop")) {
//        if("Search".equalsIgnoreCase(act)){
            ...
            try{            
	             if("TrustBookLib".equalsIgnoreCase(docBaseType)){//可信任图书库
	            	 ...
	            	 if(StringUtils.inArray(docBaseType, "","OnlineSale","DownRepeal","RecycleBin","ShutShop","NotMarked" , "Marked", "ToBeMarked" )){
	            	    System.out.println("使用新搜索进行数据查询...");
	            	   	// 管理全站图书/未标记图书/已标记图书/待标记图书
	//                    resultSet = manager.work("AdminSearch", parameters);
	            	   	if(StringUtils.inArray(docBaseType, "","OnlineSale")){
	            	   		parameters.put("dataSourceKey","online");//查询线上数据库一直的数据
	            	   	}
						//新搜索读取数据
    ...
    */
	...
	<body>
		...
		<div class="mainMenuPanel">
			...
			<a href="doc_base_manage.jsp" class="menuItemSel">已审核图书管理系统</a>
		...
		<div class="modulePanel" id="modulePanel">
			...
			<a href="javascript:selectVerifyModule(12)" class="modulePanelItem">管理下架图书</a>
			<a href="javascript:selectVerifyModule(13)" class="modulePanelItem">管理回收站图书</a>
			<a href="javascript:selectVerifyModule(14)" class="modulePanelItem">管理暂停/关闭店铺图书</a>
		</div>
...
<!-- 							<span><a href="javascript:showBelivePress(true)">选择可信任出版社</a>
 ...
 -->
			...
			<div class="sort">&nbsp;&nbsp;&nbsp;
				...
				show="search_choice_keywords_show_infomation_dom" defaultLevel="" searchType="shop">选择可疑关键字</a>
