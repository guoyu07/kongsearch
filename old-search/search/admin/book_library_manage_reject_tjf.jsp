    ...
    if(null != server){
        try{
            ...
            if("search".equalsIgnoreCase(act)){
				...
				/**添加只显示驳回的图书 start   tangjunfeng*/
                parameters.put("certifyStatus","failed");
                /**添加只显示驳回的图书 end*/
...
<a href="book_library_manage_via_tjf.jsp" class="modulePanelItem">管理图书资料库(通过)</a>
<a href="book_library_manage_reject_tjf.jsp" class="modulePanelItemSel">管理图书资料库(驳回)</a>
<!-- 
