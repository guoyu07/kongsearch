...
<%!
    ...
    private String displayHitsTable(ArrayList bookList) throws Exception{
        ...
        for(int i = 0; i < bookList.size(); i++){
            ...
            String authorIntroduction       = StringUtils.strVal(map.get("authorIntroduction"));
            String authorIntroduction_hl    = StringUtils.strVal(map.get("authorIntroduction_hl"));
            String contentIntroduction      = StringUtils.strVal(map.get("contentIntroduction"));
            String contentIntroduction_hl   = StringUtils.strVal(map.get("contentIntroduction_hl"));
            String description              = StringUtils.strVal(map.get("description"));
            String description_hl           = StringUtils.strVal(map.get("description_hl"));
            String editorComment            = StringUtils.strVal(map.get("editorComment"));
            String editorComment_hl         = StringUtils.strVal(map.get("editorComment_hl"));
            String mediaComment             = StringUtils.strVal(map.get("mediaComment"));
            String mediaComment_hl          = StringUtils.strVal(map.get("mediaComment_hl"));
            String Illustration             = StringUtils.strVal(map.get("Illustration"));
            String Illustration_hl          = StringUtils.strVal(map.get("Illustration_hl"));
            String directory                = StringUtils.strVal(map.get("directory"));
...
<a href="javascript:selectVerifyModule(4)" class="modulePanelItem">管理待确认图书</a>
</div>
