...
<%!
    ...
    private void sendNewSearchAutoSmartVerify(ArrayList logList, JspWriter out) throws Exception {
    	//创建新搜索审核实例
...
//    }
    ...
    ****************************************************************************/
    ...
    String verifyMode = StringUtils.strVal("automatic");//审核方式，自动审核 = automatic
    ...
    if(null != manager){
        ...
        if("Search".equalsIgnoreCase(act)){
            ...
            parameters.put("verifyAct", verifyAct);
            ...
            for(int pageCount = 1; pageCount <= totalCount; pageCount++){
